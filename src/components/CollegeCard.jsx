      ...
      <div className="flex flex-1 flex-col p-4">
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <Link
              ...
              className="mt-1 block text-lg font-bold leading-snug hover:text-brand-700 dark:hover:text-brand-100"
            >
              {college.name}
            </Link>
          </div>
          ...
          <button
            ...
            className={`rounded-lg border p-2 transition ${
              saved
                ...
                : 'border-slate-200 text-slate-500 hover:text-brand-700 dark:border-slate-700'
            }`}
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          ...
          <span className="inline-flex items-center gap-1 rounded-lg bg-emerald-50 px-2.5 py-1 text-xs font-semibold text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-100">
            <TrendingUp size={14} />
            {college.placementRate ?? 0}% placed
          </span>
        </div>
